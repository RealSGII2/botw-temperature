...
public class FlamebreakerArmorModifier extends LootModifier {
    ...
    public FlamebreakerArmorModifier(ILootCondition[] lootConditions) {
    ...
    public static final class Serializer extends GlobalLootModifierSerializer<FlamebreakerArmorModifier> {
        @Override
        public FlamebreakerArmorModifier read(ResourceLocation name, JsonObject json, ILootCondition[] conditionsIn) {
            return new FlamebreakerArmorModifier(conditionsIn);
        }

        @Override
        public JsonObject write(FlamebreakerArmorModifier instance) {
