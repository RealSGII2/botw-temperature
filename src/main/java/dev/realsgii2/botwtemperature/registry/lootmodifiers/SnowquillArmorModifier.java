...
public class SnowquillArmorModifier extends LootModifier {
    ...
    public SnowquillArmorModifier(ILootCondition[] lootConditions) {
    ...
    public static final class Serializer extends GlobalLootModifierSerializer<SnowquillArmorModifier> {
        @Override
        public SnowquillArmorModifier read(ResourceLocation name, JsonObject json, ILootCondition[] conditionsIn) {
            return new SnowquillArmorModifier(conditionsIn);
        }

        @Override
        public JsonObject write(SnowquillArmorModifier instance) {
