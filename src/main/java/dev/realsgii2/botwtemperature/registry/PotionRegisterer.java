...
public class PotionRegisterer {
    ...
    private static NamedPotion[] TO_REGISTER = new NamedPotion[] {
            COLD_RESISTANCE_I_SHORT, COLD_RESISTANCE_I_LONG, COLD_RESISTANCE_II_SHORT, COLD_RESISTANCE_II_LONG,
            HEAT_RESISTANCE_I_SHORT, HEAT_RESISTANCE_I_LONG, HEAT_RESISTANCE_II_SHORT, HEAT_RESISTANCE_II_LONG,
