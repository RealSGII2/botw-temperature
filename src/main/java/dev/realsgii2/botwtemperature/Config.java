...
public final class Config {
        ...
        private static ConfigValue<Double> temperatureChangeIfSnow;

        public static List<Triple<String, Double, Double>> biomeTemperatures() {
                List<? extends List<?>> rawTemperatures = biomeTemperatures.get();
                return rawTemperatures.stream()
                                .map(t -> Triple.of((String) t.get(0), (Double) t.get(1), (Double) t.get(2)))
        ...
        public static Double temperatureChangeIfSnow() {
                return temperatureChangeIfSnow.get();
        }
        ...
        public static void init() {
                ...
                temperatureChangeIfSnow = commonConfig
                                .comment("Added to the current temperature if it's snowing.",
                                                "Format: double",
                                                "Example: -0.75",
                                                "Default: -0.75")
                                .define("temperatureChangeIfSnow", -0.75);
